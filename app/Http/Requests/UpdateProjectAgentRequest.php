...
class UpdateProjectAgentRequest extends FormRequest
{
    ...
    /**
     * Add cross-field validation after the base Agent validation rules succeed.
     *
        ...
        return [
            function (Validator $validator): void {
                ...
                if (
                    ...
                    || $validator->errors()->has('skill_ids')
                ) {
                    return;
                }
                ...
                if (
                    $project->skills()->whereKey($skillIds)->count()
                    !== count(array_unique($skillIds))
                ) {
                    $validator->errors()->add(
                        'skill_ids',
                        'Skills must belong to this project.',
                    );
                }
            },
        ];
